                    ...
                    <div class="overflow-x-auto w-full  border rounded-lg border-gray-300">
                        ...
                        <?php else: ?> 
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "><?php echo e($producto->producto_id); ?></td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <?php echo e($producto->nombre_producto); ?> </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <?php echo e($producto->descripcion_producto); ?> </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">$<?php echo e($producto->precio); ?> </td>
                                <td class="p-5 whitespace-nowrap text-sm text-center leading-6 font-medium text-gray-900"> 
                                    <?php if($producto->existencia === 0): ?>
                                        <p class="text-red-900"><?php echo e($producto->existencia); ?></p>                                           
                                        <?php else: ?>
                                        <p><?php echo e($producto->existencia); ?></p>
                                    <?php endif; ?>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <?php echo e($producto->tipo); ?>:
                                    <?php if($producto->tipo === 'Porcentaje'): ?>
                                        <p class="text-blue-900"><?php echo e($producto->valor); ?>%</p>
                                    <?php else: ?>
                                        <p class="text-blue-900">$<?php echo e($producto->valor); ?></p>
                                    <?php endif; ?>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 
                                    <?php echo e($producto->categoria_principal_id); ?>:
                                    <?php if($producto->categoria_secundaria_id === 'Novedad'): ?>
                                        <p class="text-green-900"><?php echo e($producto->categoria_secundaria_id); ?></p>
                                    <?php else: ?>
                                        <p class="text-red-900"><?php echo e($producto->categoria_secundaria_id); ?></p>
                                    <?php endif; ?> 
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <?php if($producto->imagen_producto_uno): ?>
                                        <img src="<?php echo e(asset($producto->imagen_producto_uno)); ?>" alt="Imagen 1" class="rounded-full w-20 h-20 object-cover">
                                    <?php else: ?>
                                        Sin imagen
                                    <?php endif; ?>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 
                                    <?php if($producto->imagen_producto_dos): ?>
                                        <img src="<?php echo e(asset($producto->imagen_producto_dos)); ?>" alt="Imagen 1" class="rounded-full w-20 h-20 object-cover">
                                    <?php else: ?>
                                        Sin imagen
                                    <?php endif; ?>
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 
                                    <?php if($producto->imagen_producto_tres): ?>
                                        <img src="<?php echo e(asset($producto->imagen_producto_tres)); ?>" alt="Imagen 1" class="rounded-full w-20 h-20 object-cover">
                                    <?php else: ?>
                                        Sin imagen
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="flex flex-col p-5 items-center gap-2">
                                    <a href="/producto/<?php echo e($producto->producto_id); ?>/editar">
                                    ...
                                    <a href="/producto/<?php echo e($producto->producto_id); ?>/mostrar">
                                            ...
                                            <div
                                                ...
                                                <div class="flex flex-col bg-white rounded-2xl py-4 px-5">
                                                    ...
                                                    <div class="overflow-y-auto py-4 min-h-[100px]">
                                                        ...
                                                        <form action="/producto/<?php echo e($producto->producto_id); ?>/eliminar" method="post">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('/base/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Andrea\Desktop\varela\cuatrifinalizado\cuatrifinalizado\VarelaAdmin\resources\views//producto/listar.blade.php ENDPATH**/ ?>