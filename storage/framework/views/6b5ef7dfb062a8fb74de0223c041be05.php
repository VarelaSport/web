...
<?php $__env->startSection('contenido'); ?>
    <div class="container mx-auto py-20 flex justify-center">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-lg p-8">
            <form action="/cliente/<?php echo e($cliente->id); ?>/mostrar" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex gap-x-6 mb-6 justify-center">
                    <div class="w-32 h-32">
                        ...
                        <img src="<?php echo e(asset($cliente->img_perfil)); ?>" alt="imagen de perfil" readonly class="rounded-full w-full h-full object-cover">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="apellido_paterno" name="apellido_paterno" value="<?php echo e($cliente->apellido_paterno); ?>" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full relative">
                        ...
                        <input type="text" id="apellido_materno" name="apellido_materno" value="<?php echo e($cliente->apellido_materno); ?>" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full relative">
                        ...
                        <input type="number" id="telefono" name="telefono" value="<?php echo e($cliente->telefono); ?>" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="domicilio" name="domicilio" value="<?php echo e($cliente->domicilio); ?>" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="correo" name="correo" value="<?php echo e($cliente->correo); ?>" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
<?php echo $__env->make('/base/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VarelaAdmin\resources\views//cliente/mostrar.blade.php ENDPATH**/ ?>