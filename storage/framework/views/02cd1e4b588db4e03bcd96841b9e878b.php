...
<?php $__env->startSection('contenido'); ?>
    <div class="container mx-auto py-20 flex justify-center">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-lg p-8">
            <form action="/Administrador/<?php echo e($admin->id); ?>/actualizar" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex gap-x-6 mb-6 justify-center">
                    <div class="w-32 h-32">
                        ...
                        <input type="hidden" value="<?php echo e(asset($admin->img_perfil)); ?>">
                    </div>
                </div>
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="nombre" name="nombre" value='<?php echo e($admin->nombre); ?>' class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            placeholder="">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <p class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            <?php echo e($admin->nombre_usuario); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full relative">
                        <label class="flex items-center mb-2 text-gray-600 text-sm font-medium" for="rango_id">Rol de Usuario</label>
                        <select name="rango_id" id="rango_id" class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            ...
                            <option value="2">Medio Administrador</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="domicilio" name="domicilio" value="<?php echo e($admin->domicilio); ?>" class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="correo" name="correo" value="<?php echo e($admin->correo); ?>" class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-5 flex justify-between">
                    <input type="submit" value="Editar Administrador" class="w-52 h-12 bg-green-600 text-white font-semibold rounded-full shadow-sm hover:bg-green-700 transition duration-300">
...
<?php echo $__env->make('/base/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Andrea\Desktop\varela\cuatrifinalizado\cuatrifinalizado\VarelaAdmin\resources\views//Administrador/editar.blade.php ENDPATH**/ ?>