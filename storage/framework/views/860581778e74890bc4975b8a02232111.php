...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="flex gap-x-6 mt-5">
        <div class="w-full relative">
          ...
          <p readonly class="mb-3">Categoria: <?php echo e($productos->categoria_principal_id); ?></p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="w-full relative">
          ...
          <p readonly class="mb-3"><?php echo e($productos->tipo); ?>: <?php echo e($productos->valor); ?></p>
          <p readonly class="mb-3">Descuento: <?php echo e($productos->descripcion_descuento); ?></p>
...
<?php echo $__env->make('/base/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VarelaAdmin\resources\views//producto/mostrar.blade.php ENDPATH**/ ?>