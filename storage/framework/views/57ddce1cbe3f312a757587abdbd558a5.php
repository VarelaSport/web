...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="md:container md:mx-auto py-20">
        <!-- ... -->
        <div class="md:container md:mx-auto mb-10">
            <a href="/Administrador/crear" class='m-5 py-2.5 px-6 text-sm rounded-full bg-gradient-to-r from-blue-500 to-blue-300 text-white cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-gradient-to-l'>Crear Administrador</a>
            <br>
        </div>
                    ...
                    <table class="w-full rounded-xl">
                        <thead>
                            <tr class="bg-gray-50">
                                ...
                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Apellidos </th>
                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Correo </th>
                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Usuario </th>
                                <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Domicilio </th>
                        ...
                        <tbody class="divide-y divide-gray-300 ">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <img class="rounded-full w-20 h-20 object-cover" src="<?php echo e(asset($admin->img_perfil)); ?>" alt="<?php echo e(asset($admin->img_perfil)); ?>">   
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <?php echo e($admin->nombre); ?> </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> <?php echo e($admin->apellido_paterno); ?> <?php echo e($admin->apellido_materno); ?></td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <?php echo e($admin->correo); ?> </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> <?php echo e($admin->usuario); ?></td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> <?php echo e($admin->domicilio); ?> </td>
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                        ...
                                        <span class="font-medium text-xs text-emerald-600 "><?php echo e($admin->estatus); ?></span>
                                    </div>
                                </td>
                                            
                                            <td class="flex flex-col p-5 items-center gap-2">
                                                <a href="/Administrador/<?php echo e($admin->id); ?>/editar">
                                                ...
                                                <a href="/Administrador/<?php echo e($admin->id); ?>/mostrar">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex flex-col bg-white rounded-2xl py-4 px-5">
                                                                <div
                                                                    ...
                                                                    <h4 class="text-sm text-gray-900 font-medium">Eliminar Administrador:</h4>
                                                                ...
                                                                <div class="overflow-y-auto py-4 min-h-[100px]">
                                                                    ...
                                                                    <p class=" text-gray-600 text-sm">
                                                                        ¿Estas seguro de que quieres eliminar a este Administrador?
                                                                    </p>
                                                                    <br>
            
                                                                    <form action="/Administrador/<?php echo e($admin->id); ?>/borrar" method="post">
                                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('/base/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Andrea\Desktop\varela\cuatrifinalizado\cuatrifinalizado\VarelaAdmin\resources\views/administrador/listar.blade.php ENDPATH**/ ?>