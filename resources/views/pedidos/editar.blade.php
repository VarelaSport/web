...
@if ($productos->existencia === 0)
      ...
      <div class="flex gap-x-6 mt-5">
        <div class="w-full relative">
          ...
          <p class="mb-3">Categoria anterior: {{$productos->categoria_principal_id}}</p>
        ...
        <div class="w-full relative">
          ...
          <p class="mb-3">{{$productos->tipo}}: {{$productos->valor}}  Descuento: {{$productos->descripcion_descuento}}</p>
    ...
    <div class="w-full flex space-x-4">
      <div class="relative flex-1">
        ...
        {{-- <input type="file" id="imagen_producto_uno" name="imagen_producto_uno" class="mt-2"> --}}
        {{-- <input type="file" id="imagen_producto_uno" name="imagen_producto_uno" class="mt-2"> --}}
      </div>
      ...
      <div class="relative flex-1">
        ...
        {{-- <input type="file" id="imagen_producto_dos" name="imagen_producto_dos" class="mt-2"> --}}
      </div>
      ...
      <div class="relative flex-1">
        ...
        {{-- <input type="file" id="imagen_producto_tres" name="imagen_producto_tres" class="mt-2"> --}}
      </div>
    </div>
