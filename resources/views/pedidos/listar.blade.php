                    ...
                    <div class="overflow-x-auto w-full  border rounded-lg border-gray-300">
                        ...
                        @else 
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{{$orden->orden_id}}</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$orden->nombre_cliente}} </td>
                                
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$orden->nombre_administrador}} </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$orden->nombre_metodoPago}} </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$orden->totalOrden}} </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{{$orden->fecha_compra}} </td>
                                ...
                                @if ($orden->estatus === 'activo')
                                    <td class="flex flex-col p-5 items-center gap-2">
                                        <a href="/pedidos/{{$orden->orden_id}}/mostrar">
