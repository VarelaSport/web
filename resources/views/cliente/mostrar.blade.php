...
@section('contenido')
    <div class="container mx-auto py-20 flex justify-center">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-lg p-8">
            <form action="/cliente/{{$cliente->id}}/mostrar" method="POST" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
                ...
                <div class="flex gap-x-6 mb-6 justify-center">
                    <div class="w-32 h-32">
                        ...
                        <img src="{{asset($cliente->img_perfil)}}" alt="imagen de perfil" readonly class="rounded-full w-full h-full object-cover">
                    </div>
                </div>
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="nombre" name="nombre" value='{{$cliente->nombre}}' readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            placeholder="">
                        @error('nombre')
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{$cliente->apellido_paterno}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div class="w-full relative">
                        ...
                        <input type="text" id="apellido_materno" name="apellido_materno" value="{{$cliente->apellido_materno}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="nombre_usuario" name="nombre_usuario" value="{{$cliente->nombre_usuario}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <div class="w-full relative">
                        ...
                        <input type="number" id="telefono" name="telefono" value="{{$cliente->telefono}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('telefono')
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="domicilio" name="domicilio" value="{{$cliente->domicilio}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('domicilio')
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="correo" name="correo" value="{{$cliente->correo}}" readonly class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('correo')
