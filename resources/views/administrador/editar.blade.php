...
@section('contenido')
    <div class="container mx-auto py-20 flex justify-center">
        <div class="w-full max-w-3xl bg-white rounded-lg shadow-lg p-8">
            <form action="/Administrador/{{$admin->id}}/actualizar" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="flex gap-x-6 mb-6 justify-center">
                    <div class="w-32 h-32">
                        ...
                        <input type="hidden" value="{{asset($admin->img_perfil)}}">
                    </div>
                </div>
                ...
                <div class="flex gap-x-6 mb-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="nombre" name="nombre" value='{{$admin->nombre}}' class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            placeholder="">
                        @error('nombre')
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="domicilio" name="domicilio" value="{{$admin->domicilio}}" class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('domicilio')
                ...
                <div class="flex gap-x-6 mb-6 mt-6">
                    <div class="w-full relative">
                        ...
                        <input type="text" id="correo" name="correo" value="{{$admin->correo}}" class="block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('correo')
