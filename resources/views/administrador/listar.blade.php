                        ...
                        <tbody class="divide-y divide-gray-300 ">
                            ...
                            <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <img class="rounded-full w-20 h-20 object-cover" src="{{asset($admin->img_perfil)}}" alt="{{asset($admin->img_perfil)}}">   
                                </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$admin->nombre}} </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> {{$admin->apellido_paterno}} {{$admin->apellido_materno}}</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$admin->correo}} </td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> {{$admin->usuario}}</td>
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {{$admin->domicilio}} </td>
                                ...
                                <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                    <div class="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                        ...
                                        <span class="font-medium text-xs text-emerald-600 ">{{$admin->estatus}}</span>
                                    </div>
                                </td>
                                            {{-- ACCIONES --}}
                                            <td class="flex flex-col p-5 items-center gap-2">
                                                <a href="/Administrador/{{$admin->id}}/editar">
                                                ...
                                                <a href="/Administrador/{{$admin->id}}/mostrar">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex flex-col bg-white rounded-2xl py-4 px-5">
                                                                ...
                                                                <div class="overflow-y-auto py-4 min-h-[100px]">
                                                                    ...
                                                                    <form action="/Administrador/{{$admin->id}}/borrar" method="post">
                                                                        @csrf
                                                                        @method('DELETE')
